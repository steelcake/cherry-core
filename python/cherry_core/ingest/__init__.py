...
class ProviderConfig:
    ...
    retry_backoff_ms: Optional[int] = None # (Optional) Delay between retries in milliseconds, increases with each attempt.
    ...
    buffer_size: Optional[int] = None # (Optional) Internal buffer size for streaming data efficiently.
